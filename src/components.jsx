...
export function Dropdown({ OptionsMenu, Bottom = false }) {
    ...
    // TODO: Make a seperate DropUp component that is meant for when the button is on the bottom :D
    if (!Bottom) {
        return (
...
const LeftSideDefault = () => {
    return (
        <div style={{ display: "flex", alignItems: "center" }}>
            ...
            />
            {/* <img className="logo_img" src={favicon}/> */}
            <h1
